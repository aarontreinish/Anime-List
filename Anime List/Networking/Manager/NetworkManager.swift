...
struct NetworkManager {
    ...
    func getMangaRecommendations(id: Int, completion: @escaping (_ anime: [Recommendations_results]?,_ error: String?)->()) {
        router.request(.mangaRecommendations(id: id)) { data, response, error in
    ...
    func getVoiceActorsDetials(id: Int, completion: @escaping (_ anime: VoiceActors?,_ error: String?)->()) {
        router.request(.person(id: id)) { data, response, error in
    ...
    func getTopPagination(page: Int, type: String, subtype: String, completion: @escaping (_ topAiring: [TopElement]?,_ error: String?)->()) {
        router.request(.topPagination(page: page, type: type, subtype: subtype)) { data, response, error in
